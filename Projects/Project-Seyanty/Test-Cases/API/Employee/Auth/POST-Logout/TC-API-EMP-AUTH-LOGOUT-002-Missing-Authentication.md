---
tc_id: TC-API-EMP-AUTH-LOGOUT-002
...
Verify logout rejects unauthenticated request when Authorization header is omitted.
...
- **Notes:** Send POST with no Authorization, only Accept/User-Agent.
...
# Steps
1. Build POST without Authorization.
2. Send to logout.
3. Assert 401 error.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGOUT-002 - Missing Authentication
# Endpoint: POST https://seyanty.info/api/employee/logout
TITLE="TC-API-EMP-AUTH-LOGOUT-002: Missing Authentication"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
