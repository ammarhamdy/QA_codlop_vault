---
tc_id: TC-API-EMP-AUTH-LOGOUT-011
...
Validate error JSON schema for auth failures on logout.
...
- **Notes:** POST without Authorization.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGOUT-011 - Error Response Body Structure
# Endpoint: POST https://seyanty.info/api/employee/logout
TITLE="TC-API-EMP-AUTH-LOGOUT-011: Error Response Body Structure"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
