---
tc_id: TC-API-EMP-AUTH-LOGOUT-006
...
Verify logout handles malformed Authorization header gracefully.
...
- **Notes:** Send header `Authorization: BearerToken $TOKEN` (no space).
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGOUT-006 - Malformed Authorization Header
# Endpoint: POST https://seyanty.info/api/employee/logout
TITLE="TC-API-EMP-AUTH-LOGOUT-006: Malformed Authorization Header"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
