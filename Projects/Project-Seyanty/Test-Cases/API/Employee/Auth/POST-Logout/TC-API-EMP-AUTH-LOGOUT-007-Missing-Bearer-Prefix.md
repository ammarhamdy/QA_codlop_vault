---
tc_id: TC-API-EMP-AUTH-LOGOUT-007
...
| Authorization | `<valid_token>` without Bearer |
...
- **Notes:** Header `Authorization: $TOKEN` without scheme.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGOUT-007 - Missing Bearer Prefix
# Endpoint: POST https://seyanty.info/api/employee/logout
TITLE="TC-API-EMP-AUTH-LOGOUT-007: Missing Bearer Prefix"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
