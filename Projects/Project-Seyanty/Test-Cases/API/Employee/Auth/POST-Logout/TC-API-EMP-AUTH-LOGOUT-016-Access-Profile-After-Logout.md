---
tc_id: TC-API-EMP-AUTH-LOGOUT-016
title: Access Profile After Logout
priority:
  - High
status:
type:
...
Specifically verify GET profile after logout is denied.
...
| Field | Value |
| ----- | ----- |
| Endpoint | `GET https://seyanty.info/api/employee/profile` after `POST /logout` |
...
# Steps
1. Login, logout.
2. GET profile with same token.
3. Verify 401, not 200.

# Expected Result
- HTTP `401`.
- Body error `لابد من تسجيل الدخول أولا`.
...
# Notes
Dedicated profile-after-logout test.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGOUT-016 - Access Profile After Logout
# Endpoint: POST https://seyanty.info/api/employee/logout
TITLE="TC-API-EMP-AUTH-LOGOUT-016: Access Profile After Logout"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
