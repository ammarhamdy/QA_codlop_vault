---
tc_id: TC-API-EMP-AUTH-LOGOUT-005
...
Verify logout rejects expired JWT (exp in past).
...
| Authorization | `Bearer eyJ0...expInPast.expired` |

# Preconditions
- Expired token available.
...
# Expected Result
- HTTP `401`.
- Error `لابد من تسجيل الدخول أولا` (or Token expired variant).
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGOUT-005 - Expired Authentication Token
# Endpoint: POST https://seyanty.info/api/employee/logout
TITLE="TC-API-EMP-AUTH-LOGOUT-005: Expired Authentication Token"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
