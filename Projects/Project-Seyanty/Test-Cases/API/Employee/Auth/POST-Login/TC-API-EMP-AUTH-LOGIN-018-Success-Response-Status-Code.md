---
tc_id: TC-API-EMP-AUTH-LOGIN-018
title: Success Response Status Code
priority:
  - High
status:
  - completed
...
Assert successful login returns exactly HTTP 200.
...
# Steps
1. POST valid login.
2. Extract HTTP_STATUS.
3. Assert `200`.

# Expected Result
- HTTP `200` exactly, not `201` or `204`.
- Body code field also `200`.
...
# Notes
Status code must match body `code`: both 200.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-LOGIN-018 - Success Response Status Code
# Endpoint: POST https://seyanty.info/api/employee/login
TITLE="TC-API-EMP-AUTH-LOGIN-018: Success Response Status Code"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
