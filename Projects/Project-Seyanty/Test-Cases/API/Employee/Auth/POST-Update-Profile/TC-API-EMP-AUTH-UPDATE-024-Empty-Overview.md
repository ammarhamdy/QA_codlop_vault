---
tc_id: TC-API-EMP-AUTH-UPDATE-024
...
type:
  - API
linked_requirement: REQ-EMP-AUTH-UPDATE-013
tags:
  - test-case
  - api
  - employee
...
Verify handling when `overview` is empty string (should be allowed or treated as null).
...
# Steps
1. Login.
2. POST with empty overview.
3. Verify handling.

# Expected Result
- HTTP `200` with `data.overview` as `""` or `null`; not 422. Overview is typically nullable/optional.
...
# Notes
Overview often optional – empty may be accepted.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-024 - Empty Overview
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-024: Empty Overview"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
