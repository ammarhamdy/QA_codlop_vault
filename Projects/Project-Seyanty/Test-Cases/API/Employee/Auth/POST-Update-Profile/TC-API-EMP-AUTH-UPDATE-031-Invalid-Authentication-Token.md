---
tc_id: TC-API-EMP-AUTH-UPDATE-031
...
Verify update rejects invalid JWT.
...
| Authorization | `Bearer eyJ0...invalidSignature` |
...
- **Notes:** Use JWT with invalid signature.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-031 - Invalid Authentication Token
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-031: Invalid Authentication Token"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
