---
tc_id: TC-API-EMP-AUTH-UPDATE-011
title: Empty Name
priority:
  - High
status:
...
Verify validation when `name` is empty string.
...
1. Login.
2. POST with `name=""`.
3. Verify error or handling.

# Expected Result
- HTTP `422` or `400` with validation error for `name` empty, not 200/500.
...
None. Ensure name not persisted as empty.

# Notes
Empty should be treated as missing.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-011 - Empty Name
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-011: Empty Name"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
