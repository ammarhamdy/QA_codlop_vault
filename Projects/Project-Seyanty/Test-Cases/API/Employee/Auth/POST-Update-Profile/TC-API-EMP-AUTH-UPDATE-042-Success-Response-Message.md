---
tc_id: TC-API-EMP-AUTH-UPDATE-042
...
Verify success message is exactly Arabic `تم تحديث البيانات بنجاح`.
...
| Expected message | `تم تحديث البيانات بنجاح` |
...
- **Notes:** Valid POST update; check message field.
...
curl --silent --location --request POST 'https://seyanty.info/api/employee/update-profile' \
  ...
  --form 'job_title="eng"' \
  --form 'overview="experienced engineer"' | jq -r '.message'
  ```
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-042 - Success Response Message
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-042: Success Response Message"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
...
curl --silent --location --request POST 'https://seyanty.info/api/employee/update-profile' \
  ...
  --form 'phone="0500000109"' \
  --form 'job_title="eng"' \
  --form 'overview="experienced engineer"' | jq -r '.message' 2>&1)
