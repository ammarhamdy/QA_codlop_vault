---
tc_id: TC-API-EMP-AUTH-UPDATE-013
title: Empty Email
priority:
  - High
status:
...
Verify validation when `email` is empty string.
...
# Notes
Empty email must not be accepted.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-013 - Empty Email
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-013: Empty Email"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
