---
tc_id: TC-API-EMP-AUTH-UPDATE-041
...
Validate error JSON schema for auth failures and validation errors.
...
- **Notes:** POST without Authorization to force 401.
...
# Expected Result
- HTTP `401`.
- Body `{"status":"error","code":401,"message":"لابد من تسجيل الدخول أولا","data":null}`.
- Types: status string, code int, message Arabic, data null.
...
# Notes
Error code equals HTTP status.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-041 - Error Response Body Structure
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-041: Error Response Body Structure"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
