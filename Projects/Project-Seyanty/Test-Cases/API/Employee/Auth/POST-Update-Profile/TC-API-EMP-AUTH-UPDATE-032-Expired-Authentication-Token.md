---
tc_id: TC-API-EMP-AUTH-UPDATE-032
...
Verify update rejects expired JWT.
...
| Authorization | `Bearer eyJ0...expPast` |
...
- **Notes:** Send JWT with exp in past.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-032 - Expired Authentication Token
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-032: Expired Authentication Token"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
