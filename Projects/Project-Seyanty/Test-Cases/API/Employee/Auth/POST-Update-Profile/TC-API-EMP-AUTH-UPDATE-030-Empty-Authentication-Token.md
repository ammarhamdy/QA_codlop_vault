---
tc_id: TC-API-EMP-AUTH-UPDATE-030
...
Verify update rejects when Bearer token is empty.
...
- **Notes:** Send `Authorization: Bearer ` empty.
...
# Expected Result
- HTTP `401` with same Arabic message.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-030 - Empty Authentication Token
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-030: Empty Authentication Token"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
