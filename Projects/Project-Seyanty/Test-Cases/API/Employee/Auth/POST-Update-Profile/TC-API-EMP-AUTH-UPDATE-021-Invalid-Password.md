---
tc_id: TC-API-EMP-AUTH-UPDATE-021
...
Verify validation when `password` does not meet policy (too short, no complexity).
...
# Steps
1. Login.
2. POST with weak password.
3. Verify 422 with password policy message.

# Expected Result
- HTTP `422` with validation error for password (min 8, complexity).
...
# Notes
Password policy enforcement. Note: previous script had typo host seyanty – ensure correct.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-021 - Invalid Password
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-021: Invalid Password"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
