---
tc_id: TC-API-EMP-AUTH-UPDATE-039
...
# Steps
1. POST with valid token → assert 200.
2. POST without token → assert 401.
3. Ensure no 500.
...
Revert any data change from valid case.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-039 - Response Status Code
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-039: Response Status Code"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
