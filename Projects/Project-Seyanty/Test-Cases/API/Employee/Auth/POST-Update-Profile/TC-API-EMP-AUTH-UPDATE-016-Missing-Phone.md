---
tc_id: TC-API-EMP-AUTH-UPDATE-016
title: Missing Phone
priority:
  - Medium
status:
...
Verify behavior when `phone` is omitted.
...
# Steps
1. Login.
2. POST omitting phone.
3. Observe 422 or 200 with unchanged phone.

# Expected Result
- HTTP `422` if phone required, else `200` with phone unchanged.
...
# Notes
Phone may be required – document actual.

# Attachments/Script
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-016 - Missing Phone
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-016: Missing Phone"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
