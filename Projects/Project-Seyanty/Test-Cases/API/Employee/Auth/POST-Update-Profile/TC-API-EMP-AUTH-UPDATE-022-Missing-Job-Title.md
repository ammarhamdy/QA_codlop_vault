---
tc_id: TC-API-EMP-AUTH-UPDATE-022
...
Verify behavior when `job_title` is omitted.
...
# Steps
1. Login.
2. POST omitting job_title.
3. Verify 422 or 200 with unchanged job_title.

# Expected Result
- HTTP `422` if required else `200`. Document actual.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-022 - Missing Job Title
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-022: Missing Job Title"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
