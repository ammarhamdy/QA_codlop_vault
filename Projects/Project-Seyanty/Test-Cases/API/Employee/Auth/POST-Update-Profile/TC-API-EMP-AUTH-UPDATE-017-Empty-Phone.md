---
tc_id: TC-API-EMP-AUTH-UPDATE-017
title: Empty Phone
priority:
  - Medium
status:
...
Verify validation when `phone` is empty string.
...
# Steps
1. Login.
2. POST with empty phone.
3. Verify 422.

# Expected Result
- HTTP `422` validation error for phone.
...
```bash
#!/usr/bin/env bash
# Test Case: TC-API-EMP-AUTH-UPDATE-017 - Empty Phone
# Endpoint: POST https://seyanty.info/api/employee/update-profile
TITLE="TC-API-EMP-AUTH-UPDATE-017: Empty Phone"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
