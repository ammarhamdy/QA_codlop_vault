---
tc_id: TC-API-DASH-AUTH-LOGIN-005
...
3. Send `email_or_name` as `admin-1@mail.com` and `password` as an empty string.
...
# Test Case: TC-API-DASH-AUTH-LOGIN-005 - Empty Password
TITLE="TC-API-DASH-AUTH-LOGIN-005: Empty Password"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="
