---
tc_id: TC-API-DASH-AUTH-UPDATE-PROFILE-012
...
# Notes
- The update profile endpoint must require authentication.

# Attachments
```sh
#!/usr/bin/env bash

# Test Case: TC-API-DASH-AUTH-UPDATE-PROFILE-012 - Missing Authentication
TITLE="TC-API-DASH-AUTH-UPDATE-PROFILE-012: Missing Authentication"
echo "=================================================="
echo "Running: $TITLE"
echo "=================================================="

# 1. Create a minimal valid 1x1 JPEG using base64 (clean & shell-safe)
...
# 2. Execute Update Request omitting Authorization header entirely
