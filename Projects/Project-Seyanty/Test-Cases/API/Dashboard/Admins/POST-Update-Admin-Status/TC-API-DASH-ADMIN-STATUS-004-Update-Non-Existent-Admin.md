---
tc_id: TC-API-DASH-ADMIN-STATUS-004
title: Update status of a non-existent admin
priority:
  - High
status:
  - completed
...
# Steps
1. Send a `POST` request to `https://seyanty.info/api/dashboard/admins/update-status/999999`.
...
- Response body indicates the admin does not exist (e.g., `"هذا الادمن غير موجود"`).
- No status change occurs in the database.
