---
tc_id: TC-API-DASH-EMP-CREATE-004
title: Missing Phone
priority: High
status:
type: Functional
...
# Steps
1. Prepare multipart/form-data request with all required fields EXCEPT phone
...
# Notes
- Phone is a required field per API validation rules
