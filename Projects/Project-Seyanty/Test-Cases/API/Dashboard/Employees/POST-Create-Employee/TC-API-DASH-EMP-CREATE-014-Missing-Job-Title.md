---
tc_id: TC-API-DASH-EMP-CREATE-014
...
# Steps
1. Prepare multipart/form-data request with all required fields EXCEPT job_title
...
```json
{
    ...
    "data": {
        "job_title": ["حقل المسمى الوظيفي مطلوب."]
    }
}
```
...
# Notes
- Job title is a required field per API validation rules
