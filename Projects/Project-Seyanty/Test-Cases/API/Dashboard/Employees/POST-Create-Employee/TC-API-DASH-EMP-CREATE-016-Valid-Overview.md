---
tc_id: TC-API-DASH-EMP-CREATE-016
...
| phone | 0500000110 |
| job_title | eng |
| overview | Senior Software Engineer with 5+ years experience in full-stack development |
...
# Steps
1. Prepare multipart/form-data request with all valid fields including overview
...
5. Verify employee record exists in database with correct overview data
...
```
- **Database Assertions:**
  - Employee record exists with matching overview field
  - overview field contains exact text sent in request

# Notes
- Overview is an optional field
- Should accept long text content
...
--form 'job_title="eng"' \
--form 'overview="Senior Software Engineer with 5+ years experience in full-stack development"' | jq .
```
