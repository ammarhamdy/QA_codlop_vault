...
status:
  ...
  - in-progress
  - completed
start_date: 2026-08-19T16:17:00
end_date: 2026-08-20T12:59:00
tags:
  - test-run
---
...
views:
  - type: table
    ...
    filters:
      or:
        - file.inFolder("Projects/Project-Seyanty/Test-Cases/API/Dashboard/Admins")
    groupBy:
...
const folderPaths = [
	"Projects/Project-Seyanty/Test-Cases/API/Dashboard/Admins"
];
