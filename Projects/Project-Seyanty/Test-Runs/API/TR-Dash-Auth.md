...
status:
  - in-progress
start_date: 2026-08-18T15:39:00
end_date:
tags:
  - test-run
---
...
views:
  - type: table
    ...
    filters:
      or:
        - file.inFolder("Projects/Project-Seyanty/Test-Cases/API/Dashboard/Auth")
    groupBy:
...
const folderPaths = [
"Projects/Project-Seyanty/Test-Cases/API/Dashboard/Auth"
];
