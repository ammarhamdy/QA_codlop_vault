---
tc_id: TC-PStat-010
title: Verify Statistics After Activating and Deactivating Property Status
priority:
  - High
status:
  - Ready
...
# Preconditions
-At least one active and one inactive status exist.
# Steps
1. Record the current total, active, and inactive counts.  
2. Activate an inactive status.  
3. Deactivate an active status.  
