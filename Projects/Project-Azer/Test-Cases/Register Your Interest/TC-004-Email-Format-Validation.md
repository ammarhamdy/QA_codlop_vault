...
# Preconditions
User is on  Register Your Interst page.
# Steps
1. Navigate to the 'Register Your Interst' page.
2. Fill in valid data for Name, Phone Number, Message Content, and Entity,Partenership Type.
...
- The user should remain on the 'Register Your Interst' page.
# Notes
