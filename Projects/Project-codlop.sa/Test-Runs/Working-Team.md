...
views:
  - type: table
    ...
    filters:
      or:
        - file.inFolder("Projects/Project-codlop.sa/Test-Cases/Working-Team")
    groupBy:
...
const folderPaths = [
	"Projects/Project-codlop.sa/Test-Cases/Working-Team"	
];
